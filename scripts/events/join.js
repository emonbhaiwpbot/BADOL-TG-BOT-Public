...
const BG_IMAGES = [
  "https://drive.google.com/uc?export=download&id=1LBeQm5tw5DgPpVah-_mIkTU97ngRw1mc",
  "https://drive.google.com/uc?export=download&id=1OUkaQfEZqSVDkDoq9hIu1jEGE67sMqLe"
];
...
async function createBanner(data){
  ...
  ctx.fillText(`BADOL-TG-BOT • Total: ${data.member} Members`, width/2, height-25);
  ...
  BADOL: async function ({ event, api, message, newMembers, ctx }) {
    try {
      ...
      for (const member of newMembers) {
        // BOT JOINED CASE - ✅✅ PREMIUM BOX FIXED ✅✅✅
...
╰─❖─〔 𝐁𝐀𝐃𝐎𝐋-𝐓𝐆-𝐁𝐎𝐓 〕─❖─╯`;
        ...
        // USER JOINED CASE - CANVAS সহ - 100% SAME AS BEFORE
