<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=32&pause=1000&color=00F2FF&center=true&vCenter=true&width=800&lines=𝄞⋆⃝🧚‍+EREN-AI+v2.0+🧚‍⋆⃝𝄞;ULTIMATE+DEVELOPER+GUIDE+FINAL+V4.0;Author:+MOHAMMAD+BADOL;ID:+6954597258;Auto+Button+Router+%7C+SafeName+Fix+%7C+110%2B+Cmds" alt="Typing SVG" />
</p>
...
# 📖 Eren-AI v2.0 — Ultimate Developer Guide FINAL V4.0

> **লেখক: MOHAMMAD BADOL | ID: 6954597258 | সব কমান্ড, ইভেন্ট, হ্যান্ডলার ও অটোলোড সিস্টেমের সম্পূর্ণ গাইড**

<div align="center">

![EREN-AI](https://capsule-render.vercel.app/api?type=rect&color=gradient&customColorList=0,2,6,11,20&height=60&section=header&text=BADOL%20ENGINE%20v2.0&fontSize=30&fontColor=FFFFFF&animation=fadeIn)
...
```bash
Eren-AI/
├── 🚀 Eren.js         # মেইন কোর (GBAN, Owner Lock, DB Init, Login)
...
## 📝 3. কমান্ড ফাইলের গঠন (scripts/cmds)

**ফাইল রাখতে হবে:** `scripts/cmds/আপনারকমান্ড.js` (File Name = config.name হতে হবে Auto Button Router এর জন্য)
...
## 🎯 4. ইভেন্ট ফাইলের গঠন (scripts/events)

**ফাইল রাখতে হবে:** `scripts/events/আপনারইভেন্ট.js`
...
**MEANING:**
- File: `scripts/cmds/help.js`, config.name: `help`
...
CACHE_DIR = path.join(__dirname, '..', 'scripts', 'cache') - Auto created
```
